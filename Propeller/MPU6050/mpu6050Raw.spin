...
PUB TestMPU  | MPUcog, normAcc, dirVx, dirVy, dirVz, fnormAcc, a,b,r, radToDeg
 '-----------------------------------------------
  ...
  repeat
    debug.str(string("Gyro X: "))
    debug.dec(GetRX)
    debug.tx(13)
    debug.str(string("Gyro Y: "))     
    debug.dec(GetRY)
    debug.tx(13)
    debug.str(string("Gyro Z: "))     
    debug.dec(GetRZ)
    debug.tx(13)
    debug.str(string("Acc X: "))
    debug.dec(GetAX)
    debug.tx(13) 
    debug.str(string("Acc Y: "))      
    debug.dec(GetAY)
    debug.tx(13) 
    debug.str(string("Acc Z: "))      
    debug.dec(GetAZ)
    debug.tx(13)
    
    debug.tx(10) ' clear screen
